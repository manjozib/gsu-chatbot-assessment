...
- **Request Body**:
  - `ChatRequest`: Object containing:
    ...
    - **sessionId**: seesion ID created per each and every logged session.
```json
{
  "message": "message",
...
```
- **Response**:
  - Returns a `ChatResponse` object with the reply.
...
- **Request Body**:
  - `FaqCreateRequest`: Object with:
    - **category**: The FAQ category.
    - **question**: The FAQ question.
    - **answer**: The FAQ answer.
    - **keywords**: The FAQ keywords separated by comma.
```json
{
  "category": "category",
  "question": "question",
...
- **Request Body**:
  - `FaqCreateRequest`: Object with updated FAQ details.
    - **category**: The FAQ category.
    - **question**: The FAQ question.
    - **answer**: The FAQ answer.
    - **keywords**: The FAQ keywords separated by comma.
...
```
- Response:
  - Returns a `FaqResponse` object with the updated details.
